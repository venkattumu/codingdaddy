...
if(isset($_POST['submit'])){
    ...
    if(!empty($username) && !empty($email)){
        if($user->username != $username && $getFromUser->checkUsername($username) === true){
            ...
            $error['username'] = "Only character and numbers are allowed";
        } else if(!filter_var($email, FILTER_VALIDATE_EMAIL)){
            $error['email'] = "invalid email format";
        } else if($user->email != $email && $getFromUser->checkEmail($email) === true ){
        ...
        $error['fields'] = "All feilds are required";
...
<div class="nav-container">
  <!-- Nav -->
   <div class="nav">
		 <div class="nav-left">
			<ul>
				<li><a href="<?php echo BASE_UR; ?>home.php"><i class="fa fa-home" aria-hidden="true"></i>Home</a></li>
 				<li><a href="<?php echo BASE_UR; ?>i/notifications"><i class="fa fa-bell" aria-hidden="true"></i>Notification</a></li>
